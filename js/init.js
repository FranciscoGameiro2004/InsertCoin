...
if (!localStorage.getItem('levels'))
{
    ...
    [
        ...
        '<area id="challengeArea" class="blockDoor" alt="TRAVA" title="TRAVA" coords="674,258,618,180" shape="rect">', 
    ...
    [
        [''],
        ['<area id="challengeArea" class="aDoor" alt="TRAVA" title="TRAVA" coords="438,53,596,405" shape="rect">', '<area id="challengeArea" alt="TRAVA" title="TRAVA" coords="589,58,533,406" shape="rect">'],
